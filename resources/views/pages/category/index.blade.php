...
@section('content')
    @include('layouts.navbars.auth.topnav', ['title' => 'Thể loại'])
...
@push('js')
    ...
    <script>
        ...
        $(document).on('click', '.btn-delete', function() {
            ...
            $('.container-text').text('');
            id = $(this).data('id');
            $('.container-text').text('Bạn có chắc chắn muốn xóa thể loại ' + $(this).data('name') + ' không?' );
        });
        ...
        $('.btn-add').click(function(){
            $('#labelModal').text('Thêm mới thể loại');
